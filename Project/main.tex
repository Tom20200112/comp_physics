...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{figure}[H]
        ...
        \caption{MC lattice energy versus time 1}
        \label{fig:energy_to_time_lattice_mc1}
    \end{figure}
    The statistical values are
    \begin{equation}
        \label{Eq:mc_stat_lattice1}
        \begin{aligned}
            \left\langle U\right\rangle&= -168.792    \\
            \left\langle u\right\rangle&=\frac{\left\langle U\right\rangle}{N}=-2.084            \\
            \delta U^2&=20.126  \\
            \left| \frac{\delta U}{\left \langle U\right\rangle} \right|&\approx 2.66\%
        \end{aligned}
    \end{equation}
